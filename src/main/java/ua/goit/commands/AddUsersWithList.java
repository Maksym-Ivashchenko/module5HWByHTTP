...
public class AddUsersWithList implements Command {
    public static final String ADD_USER_WITH_LIST = "add_user_with_list";
    private final View view;
    private final UserRequests userRequests;

    public AddUsersWithList(View view, UserRequests userRequests) {
        this.view = view;
    ...
    public boolean canExecute(String input) {
        return input.equals(ADD_USER_WITH_LIST);
    }
            ...
            if (userData.length == countOfFields) {
                ...
                while (true) {
                    try {
                        ...
                        users.add(user);
                        ApiResponse apiResponse = userRequests.addUsersWithList(users);
